...
public class ElementRegistry {
    ...
    static {
       ...
       */
        ...
        mobile.put(ElementKey.SCROLL_TO_BUTTON,
                AppiumBy.androidUIAutomator(
        ...
        mobile.put(ElementKey.REMOTE_VIDEO_CONTAINER,
                AppiumBy.androidUIAutomator("new UiSelector().resourceId(\"com.ale.rainbow:id/no_video_view\").instance(0)"));//enable,display
        ...
        mobile.put(ElementKey.REGENERATE_NEW_PASSWORD, AppiumBy.id("com.ale.rainbow:id/passwordReset"));
